    ...
    <table align="center">
      <tr>
        ...
        <td>
          <?php
          $id = $_GET['kalku'];
          $query = "select*from nasabah,barang b,jenis_barang j,nasabah n where b.id_jenis=j.id_jenis and n.nik=b.nik and id_barang='$id'";
          $result = mysqli_query($conn, $query);
          $row = mysqli_fetch_array($result)
          ?>
          <input class='form-control' type='text' value="<?php echo $row['jenis_barang']; ?>" readonly>
          <input name="jenis" type="hidden" value="<?php echo $row['id_jenis']; ?>">
        ...
        <table align="center">
          <tr>
            ...
            <td class='form-control bg-gray-200'><?php echo "Rp." . number_format($harga, 0, ".", "."); ?>
              ...
              <input name='barang' readonly class='form-control' type='hidden' value='<?php echo $row['id_barang']; ?>'>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td>NIK Nasabah</td>
            <td>:</td>
            <td><input required name='nasabah' class='form-control' id="nasabah" type='text' readonly="readonly" value="<?php echo $row['nik']; ?>">
            </td>
          </tr>
          <tr>
            <td>Nama Nasabah</td>
            <td>:</td>
            <td><input type="text" id="nama" class='form-control' name="nama" value="<?php echo $row['nama_nasabah']; ?>" readonly="readonly" /></td>
          </tr>
          <tr>
            <td>Pengelola</td>
            <td>:</td>
          ...
          <tr>
            ...
            <td>:</td>
            <td>
              <input required type="file" name="trx_gambar" />
            </td>
          </tr>
          <tr hidden>
            <td>Keterangan</td>
          ...
          <tr>
            ...
            <td></td>
            <td>
              <button type="submit" name="btn_perjanjian1" class="btn btn-info">Simpan Data Pegadaian</button>
            </td>
          </tr>
        </table>
